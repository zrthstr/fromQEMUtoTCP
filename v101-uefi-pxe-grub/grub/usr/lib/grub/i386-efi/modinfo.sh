...
# Build environment
grub_target_cc='gcc'
grub_target_cc_version='gcc (GCC) 13.2.1 20230801'
...
grub_target_cppflags=' -Wall -W  -DGRUB_MACHINE_EFI=1 -DGRUB_MACHINE=I386_EFI -m32 -nostdinc -isystem /usr/lib/gcc/x86_64-pc-linux-gnu/13.2.1/include -I$(top_srcdir)/include -I$(top_builddir)/include'
